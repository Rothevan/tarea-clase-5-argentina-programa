...
//TAREA 1.1: crear un formulario donde un usuario pueda ingresar su salario anual.
...
$buttonCalculate.onclick = function() {
  ...
  document.querySelector("#salario-mensual").value = 'El salario mensual es ' + salarioMensual;
}
